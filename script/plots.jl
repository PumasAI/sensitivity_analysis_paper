...
p2 = plot(sensitivities_ad[1]',xlabel="Time",title="DSAAD",legend=false)
p3 = plot(sensitivities_diff[1]',xlabel="Time",title="Continuous SA",legend=false)
...
p1_b = plot(sol_bruss'[:,[1,26]],xlabel = "Time",title="ODE Solution",legend=false)
p2_b = plot(sensitivities_bruss_ad[1]'[:,[1,26]],xlabel="Time",title="DSAAD",legend=false)
p3_b = plot(sensitivities_bruss_diff[1]'[:,[1,26]],xlabel="Time",title="Continuous SA",legend=false)
